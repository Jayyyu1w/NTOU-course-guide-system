...
const links =
  'https://database--project.000webhostapp.com/get_information.php?course_ID=' +
  class_ID.value +
  '&class=' +
  course_class.value

const links2 =
  'https://database--project.000webhostapp.com/get_hot_avg.php?course_ID=' +
  class_ID.value +
  '&class=' +
  course_class.value
...
const getAvg = () => {
  var avg = star.value / 1
  star.value = (avg * 1).toFixed(2)
  return 'star' + star.value
}

const edit = () => {
  router.push({
    path: '/course/info/' + class_ID.value + '/edit',
    query: { course_ID: class_ID.value, class: class_name.value }
  })
...
const clickNo = () => {
  document.getElementById('textDisplay').innerHTML =
    "<h4 class='fw-bolder'>感謝您的回覆<br>我們會持續改進</h4>"
}
</script>
            ...
            <div class="col-md-8">
              <div class="container border">
                <div class="row h-100 pr-4 pt-3 mb-4">
                  <div class="text-dark fw-bold cinfo">課程資訊</div>
                </div>
                ...
                <div id="md-editor" class="container">
                  <MdPreview language="zh-TW" :modelValue="text" :editorId="id" />
                  <MdCatalog language="zh-TW" :editorId="id" :scrollElement="scrollElement" />
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="container border">
                <div class="pr-4 pt-3 mb-4">
                  ...
                  <div class="row" id="textDisplay">
                    <div class="col-md-1">
                      <button type="button" class="btn btn-success" id="yes" @click="clickYes">
                        是
                      </button>
                    </div>
                    <div class="offset-md-2 col-md-1">
                      <button type="button" class="btn btn-danger" id="no" @click="clickNo">
                        否
                      </button>
                    </div>
                  </div>
