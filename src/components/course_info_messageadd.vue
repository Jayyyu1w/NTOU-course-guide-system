		...
		<div class="row">
			<div class="col-md-12">
				<div class="card col-md-8">
					<div class="row">
						<div class="col-2">
							<img src="https://database--project.000webhostapp.com/img/mark (1).png" id="pic" width="70" class="rounded-circle mt-2">
						</div>
						<div class="col-10">
							<div class="comment-box ml-2">
								...
								<div class="comment-area">
									<textarea v-if="isLogin != 0" class="form-control" ref="text" placeholder="留下你的看法"
										rows="3"></textarea>
									<textarea v-else class="form-control" ref="text" placeholder="請登入以留言" rows="3" disabled></textarea>
								</div>
