...
INSERT INTO `bulletin` (`bulletin_ID`, `content`, `course_ID`, `class`) VALUES
('bulletin', 'content', 'test_course_ID', 'test_class');
...
INSERT INTO `course` (`course_ID`, `name`, `class`, `teacher`, `semester`, `dept`, `credit`) VALUES
('test_course_ID', 'test_name', 'test_class', 'test_teacher', '1101', 'test_dept', 3);
