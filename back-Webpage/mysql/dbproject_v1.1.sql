...
--
ALTER TABLE `course`
  ADD CONSTRAINT `course_bulletin_fk` FOREIGN KEY (`course_ID`,`class`) REFERENCES `bulletin` (`course_ID`, `class`),
  ADD CONSTRAINT `course_message_fk` FOREIGN KEY (`course_ID`,`class`) REFERENCES `message` (`coures_ID`, `class`),
  ADD CONSTRAINT `course_my_course_fk` FOREIGN KEY (`course_ID`,`class`) REFERENCES `my_course` (`course_ID`, `class`);
